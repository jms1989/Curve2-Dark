...
$txt['forum_width_desc'] = 'Set the forum width. Examples: 950px, 80%, 1240px. Default: 1170px.';
$txt['homepage_title'] = 'Home Page Name';
$txt['homepage_url'] = 'Home Page URL';
$txt['homepage_desc'] = 'URL to home page if the forum is in a subdirectory or sub-domain.';
$txt['homepage_enable'] = 'Enable homepage button';
